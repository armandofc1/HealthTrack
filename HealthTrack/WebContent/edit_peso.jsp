...
<layout:genericpage>
	...
	<jsp:attribute name="sessao">Editar Peso</jsp:attribute>
	...
	<jsp:body>
            ...
            <form id="formAddPeso" action="PesoAtualizar" method="post">
            	<input type="hidden" id="pesoCodigo" name="codigo" value="${requestScope.codigo}">
				<div class="row">
					<div class="col">
						<div class="form-group">
							<label for="pesoValor">Peso:</label>
							<input type="text" class="form-control" name="pesoValor" id="pesoValor" onkeypress="return Utils.isNumberKey(event,this)" placeholder="Peso" value="${requestScope.pesoValor}">
						</div>
						<div class="form-group">
							<label for="pesoDataHora">Data e hora:</label>
							<input type="type="text" class="form-control datepicker" name="pesoDataHora" id="pesoDataHora" placeholder="dd/mm/aaaa" value="${requestScope.pesoDataHora}">
						</div>
					</div>
				</div>
				<div class="row">
