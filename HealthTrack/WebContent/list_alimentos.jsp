...
<layout:genericpage>
	...
	<jsp:attribute name="sessao">Alimentos</jsp:attribute>
    <jsp:attribute name="js">
    	<script src="lib/DataTables/datatables.min.js"></script>
		<script src="js/list_alimentos.js"></script>
    </jsp:attribute>
	<jsp:body>
            <div class="ht-header-table">
                <a class="btn btn-primary" aria-pressed="true" href="add_alimento.jsp">Adicionar</a>
            </div>
            ...
            <table id="grid" class="table table-striped table-sm">
		        ...
		        <jsp:include page="/AlimentoListar"/>
		    </table>
