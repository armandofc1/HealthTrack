...
<layout:genericpage>
	...
	<jsp:attribute name="sessao">Editar Atividade Física</jsp:attribute>
    <jsp:attribute name="js">
		<script src="js/edit_atividade_fisica.js"></script>
    </jsp:attribute>
	<jsp:body>
			<div class="alert alert-danger alert-dismissible" id="alertFormErros" role="alert">
                <strong>Atenção!</strong> <span id="formErros"></span>
            </div>
            <form id="formAddAtividade" action="AtividadeFisicaAtualizar" method="post">
                <input type="hidden" id="pesoCodigo" name="codigo" value="${requestScope.codigo}">
                <input type="hidden" id="tipoCodigo" name="tipoCodigo" value="${requestScope.atividadeTipo}">
				<div class="row">
					<div class="col">
						<div class="form-group">
							<label for="atividadeNome">Nome da atividade:</label>
							<input type="text" class="form-control" name="atividadeNome" id="atividadeNome" placeholder="Atividade" value="${requestScope.atividadeNome}">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="atividadeDescricao" id="atividadeDescricao" rows="3">${requestScope.atividadeDescricao}</textarea>
						</div>
						<div class="form-group">
							<label for="atividadeCalorias">Número de calorias:</label>
							<input type="text" class="form-control" name="atividadeCalorias" id="atividadeCalorias" onkeypress="return Utils.isNumberKey(event,this)" placeholder="Calorias" value="${requestScope.atividadeCalorias}">
						</div>
						<div class="form-group">
							<label for="atividadeDataHora">Data e hora:</label>
							<input type="text" class="form-control datepicker" name="atividadeDataHora" id="atividadeDataHora" placeholder="dd/mm/aaaa" value="${requestScope.atividadeDataHora}">
						</div>
					</div>
				</div>
				<div class="row">
